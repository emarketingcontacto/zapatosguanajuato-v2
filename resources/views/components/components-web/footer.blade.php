    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
                ...
                <a href="tel:+{{$siteSettings['telefono']}}"
                    class="inline-flex items-center gap-2 bg-white/5 border border-white/10 px-4 py-3 rounded-xl text-white text-[10px] font-black uppercase hover:bg-indigo-600 transition-all">
        ...
        <div class="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex gap-6 text-white">
                {{-- Facebook --}}
                <a
                    class="hover:text-indigo-600 transition-all"
